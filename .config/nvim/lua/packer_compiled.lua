...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'Comment.nvim', 'nvim-treesitter', 'nvim-cmp', 'nvim-colorizer.lua', 'gitsigns.nvim', 'null-ls.nvim', 'nvim-lsp-installer', 'lspsaga.nvim', 'FixCursorHold.nvim', 'neoscroll.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
